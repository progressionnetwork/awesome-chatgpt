...
- A prompt to text rephrase from ChatGP```The following text is written by native English speaker. However, you need to rephrase it and to make it more understandable for people who learning English. Also, if there a play of words or slang, explain it.
